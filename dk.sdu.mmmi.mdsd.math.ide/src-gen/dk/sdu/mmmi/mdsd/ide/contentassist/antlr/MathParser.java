...
public class MathParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MathGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getVarBindingAccess().getNameAssignment_0(), "rule__VarBinding__NameAssignment_0");
			builder.put(grammarAccess.getVarBindingAccess().getExpressionAssignment_2(), "rule__VarBinding__ExpressionAssignment_2");
